            ...
            if (args.length != 3) {
                ...
                if (args[0].equalsIgnoreCase("add")) {
                    if (MySQL.isRegistered(uuid)) {
                        ...
                        sender.sendMessage(String.valueOf(Citybuild.getPrefix()) + "§7Der Kontostand von dem Spieler §8'§e" + offlinetarget.getName() + "§8' §7beträgt nun §8'§e" + money + "$§8'§7!");
                        if (t != null) {
                            sb.update();
                        }
                    } else {
                    ...
                    if (MySQL.isRegistered(uuid)) {
                        ...
                        sender.sendMessage(String.valueOf(Citybuild.getPrefix()) + "§7Der Kontostand von dem Spieler §8'§e" + offlinetarget.getName() + "§8' §7beträgt nun §8'§e" + amount + "$§8'§7!");
                        if (t != null) {
                            sb.update();
                        }
                    } else {
